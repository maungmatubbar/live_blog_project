                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('slider.update') }}" method="post" enctype="multipart/form-data">@csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="title" id="title" value="{{ $slider->title }}" class="form-control" placeholder="Enter title" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="url" id="url" value="{{ $slider->url }}" class="form-control" placeholder="Enter url" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    @if(!empty($slider->image))
                                        <img class="post-image mt-2" src="{{ asset($slider->image) }}" alt="member image">
                                    @endif
                                </div>
                            </div>
                            <div class="row mb-3">
