            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="text-left mb-4"><h4 class="card-title">Add New Category</h4></div>
                        <form id="sectionForm" action="{{ route('category.store') }}" method="post">@csrf
                            <div class="row mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-9 offset-3">
                                    <button type="submit" id="category" class="btn btn-primary">Add Category</button>
                                </div>
                            </div>
                        </form>
                    </div>
