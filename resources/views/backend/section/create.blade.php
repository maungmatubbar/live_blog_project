            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="text-left mb-4"><h4 class="card-title">Add New Section</h4></div>
                        <form id="sectionForm" action="{{ route('section.store') }}" method="post">@csrf
                            <div class="row mb-3">
                                <label for="section_name" class="col-md-3">Section Name</label>
                                <div class="col-md-9">
                                    <input type="text" name="name" id="section_name" class="form-control" placeholder="Enter section name">
                                    <p class="text-danger section_name_error mb-0"></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-9 offset-3">
                                   <button type="submit" id="section" class="btn btn-primary">Add Section</button>
                                </div>
                            </div>
                        </form>
                    </div>
